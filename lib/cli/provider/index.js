...
module.exports.builder = function(yargs) {
  ...
  return yargs
    ...
    .option('stf-appium-port', {
      describe: 'The appium\'s port for remote debug'
    , type: 'number'
    , default: false
    })
    .option('public-node-ip', {
      describe: 'The public ip for appium\'s proxy server'
    , type: 'string'
    , default: '127.0.0.1'
    })
    .option('device-name', {
...
module.exports.handler = function(argv) {
  ...
  , fork: function(device, ports) {
      ...
      , '--stf-appium-port', argv.stfAppiumPort
      , '--public-node-ip', argv.publicNodeIp
      ]
