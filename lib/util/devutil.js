...
devutil.makeIdentity = function(serial, properties) {
  ...
  // update model name for human readavle values based on env variables
  var device_udid = process.env.STF_PROVIDER_DEVICE_UDID
  var device_name = process.env.STF_PROVIDER_DEVICE_NAME
