...
let readyDevices = {}
const iosutil = require('../../lib/units/ios-device/plugins/util/iosutil')
  ...
  sub.on('message', wirerouter()
    .on(wire.ConnectDeviceViaUSB, function(channel, message) {
      ...
      privatTracker.on('startWdaOnPorts', msg => {
        ...
        let args = [
          '-project', '/Users/develop/Documents/ISTF/WebDriverAgent/WebDriverAgent.xcodeproj', // path to WebDriverAgent
