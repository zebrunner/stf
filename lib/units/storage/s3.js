...
var storageAuth = require('./middleware/storage-auth')
...
module.exports = function(options) {
  ...
  var requireStorageAuth = storageAuth({
  ...
  app.post('/s/upload/:plugin', requireStorageAuth, function(req, res) {
  ...
  app.get('/s/blob/:id/:name', requireStorageAuth, function(req, res) {
    var params = {
      Key: req.params.id
    , Bucket: options.bucket
    }
