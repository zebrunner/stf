...
module.exports = function(options) {
  ...
  Promise.map(options.endpoints.push, function(endpoint) {
    return srv.resolve(endpoint).then(function(records) {
      return srv.attempt(records, function(record) {
        log.info('[Websocket service] Sending output to "%s"', record.url)
  ...
  sub.on('message', function(channel, data) {
    log.important('websockets sub message :', channel.toString())
  ...
  io.on('connection', function(socket) {
    ...
    function joinChannel(channel) {
      ...
      log.important('websocket JoinChannel :', channel)
    ...
    var messageListener = wirerouter()
      ...
      .on(wire.TransactionTreeMessage, function(channel, message) {
        log.important('TransactionTreeMessage message :', message)
