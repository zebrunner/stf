    ...
    new Promise(function(resolve) {
      socket.on('disconnect', resolve)
        ...
        .on('group.invite', function(channel, responseChannel, data) {
          log.info('group.invite channel', channel)
          log.info('group invite responseChannel', responseChannel)
          log.info('group.invite data', data)
          log.info('group.invite user', user)
          joinChannel(responseChannel)
          push.send([
            channel
          , wireutil.transaction(
