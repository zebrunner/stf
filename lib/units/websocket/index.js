...
module.exports = function(options) {
  ...
  sub.on('message', function(channel, data) {
    log.info('Subscribing to permanent webosocket sub.on channel "%s"', channel)
  ...
  io.on('connection', function(socket) {
    ...
    var messageListener = wirerouter()
      ...
      .on(wire.InstalledApplications, function(channel, message, data) {
        log.important('channel :', channel.toString())
        log.important('InstalledApplications , message ', message)
        log.important('InstalledApplications , data ', data)
        socket.emit('device.applications', {
          important: true,
