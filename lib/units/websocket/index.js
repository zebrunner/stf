...
module.exports = function(options) {
  ...
  io.on('connection', function(socket) {
    ...
    var messageListener = wirerouter()
      ...
      .on(wire.TestPush, function(channel, message) {
        socket.emit('device.applications', {
          installedApplications: JSON.parse(message.installed)
        })
      })
      .on(wire.TransportInstalledApps, function(channel, message) {
        log.important('SetListApplications, message:', message)
        // socket.emit('device.applications', {
        //   installedApplications: JSON.parse(message.installed)
        // })
      })
