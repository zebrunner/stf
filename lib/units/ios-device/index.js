      ...
      return syrup.serial()
        ...
        .define(function(options, heatbeat, solo, push, sub,
         storage, devicelog, stream, wda, connect) {
          ...
          log.important('OPTIONS PORTS', options.connectPort, options.wdaServerPort)
          proxyConnectPort = spawn(
            'mobiledevice',
            ['tunnel', options.connectPort, options.connectPort]
          )
          proxyWdaServerPort = spawn(
            'mobiledevice',
            ['tunnel ', options.wdaServerPort, options.wdaServerPort]
          )
