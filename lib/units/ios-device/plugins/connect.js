...
module.exports = syrup.serial()
  ...
  .define((options, router, push,  wda) => {
    ...
    router.on(wire.ConnectStartMessage, (channel) => {
      log.important(`Trying to connect to WDA. Host: ${options.wdaHost}; Port: ${options.wdaPort}`)
      wda.connect()
    ...
    router.on(wire.UngroupMessage, (channel) => {
//      wirerouter().removeAllListeners()
      log.important("TODO: remove all listeners...")
    })
  })
