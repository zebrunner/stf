    ...
    router.on(wire.InstallMessage, function(channel, message) {
      ...
      mkdir(tmpDirPath)
        .then(() => {
          ...
          let httpServer = http
          if (source.uri.href.includes("https://")) {
            httpServer = https
          }
          const req2 = httpServer.get(source.uri.href, function(response) {
            response.pipe(file)
            ...
            response.on("data", (chunk) => {
             ...
             file.on("finish", () => {
                 ...
                 .catch(function(err) {
                   ...
                   if (err.stack.toString().contains('ApplicationVerificationFailed')) {
