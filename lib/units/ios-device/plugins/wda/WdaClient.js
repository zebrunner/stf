...
*/
  ...
  return WdaClient
    ...
    socket.on('error', (error) => {
      ...
      notifier.setDeviceTemporaryUnavialable(error)
      lifecycle.fatal(error) // exit with error code 1 is the best way to activate valid auto-healing steps with container(s) restart
    });
})
