...
module.exports = function(options) {
  ...
  app.use(function(req, res, next) {
    ...
    // Refuse framing so the login flow cannot be clickjacked (SLV-008).
  ...
  app.get('/auth/openid/verify', function(req, res, next) {
    ...
    relyingParty.verifyAssertion(req, function(err, result) {
      ...
      // Establish the session in the shared `ssid` cookie and redirect to a
