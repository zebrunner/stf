...
module.exports = function(options) {
  var iosusb = require('../../util/ios-usb')(options)
  ...
  iosusb.on('addDevice', (deviceId) => {
    ...
    var willStop = false
    var timer, worker
    // if(device.id === '6775adad13570022147ce70b6e24d709f90a0ffb') {
    ...
    var register = new Promise(function(resolve) {
      try {
        ...
        console.log('emit addDevice with err', e)
      }
    ...
    iosusb.on('remove', removeListener)
