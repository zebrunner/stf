...
stf processor proc001 --connect-app-dealer tcp://127.0.0.1:7112 --connect-dev-dealer tcp://127.0.0.1:7115 --public-ip ${DEVICE_IP} --connect-push tcp://127.0.0.1:7116 &
stf reaper reaper001 --connect-push tcp://127.0.0.1:7116 --connect-sub tcp://127.0.0.1:7111 &

stf auth-mock --port 7120 --secret kute kittykat --app-url http://${DEVICE_IP}:7100/ &
stf app --port 7105 --secret kute kittykat --auth-url http://${DEVICE_IP}:7100/auth/mock/ --websocket-url http://${DEVICE_IP}:7110/ &
